 ...
 */
public class Refl2RadTargetProductSelector {
    ...
    private Refl2RadTargetProductSelectorModel model;

    public Refl2RadTargetProductSelector(Refl2RadTargetProductSelectorModel model) {
        this.model = model;
    ...
    public Refl2RadTargetProductSelectorModel getModel() {
        return model;
    }
