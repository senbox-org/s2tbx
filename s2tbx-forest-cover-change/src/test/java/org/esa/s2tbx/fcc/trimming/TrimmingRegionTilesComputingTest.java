...
public class TrimmingRegionTilesComputingTest extends AbstractOpTest {
    ...
    public void testDifferenceTrimming() throws Exception {
        ...
        TrimmingRegionTilesComputing trimming = new TrimmingRegionTilesComputing(segmentationSourceProduct, sourceProduct, sourceBandIndices, tileSize.width, tileSize.height);
