...
public class Sentinel3ProductReaderPlugInR implements ProductReaderPlugIn {
    ...
    public Sentinel3ProductReaderPlugInR() {
    ...
    private Sentinel3ProductReaderPlugInR(String formatName,
                                          String description,
    ...
    public final ProductReader createReaderInstance() {
        return new Sentinel3ProductReaderR(this);
    }
