 ...
 * 
 * <p>Classe Java pour A_TILE_DESCRIPTION complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="A_TILE_DESCRIPTION">
 *   &lt;complexContent>
...
@XmlType(name = "A_TILE_DESCRIPTION", propOrder = {
    "horizontalcsname",
    "horizontalcscode",
    "size",
    "geoposition"
...
@XmlSeeAlso({
    _int.esa.gs2.dico._1_0.pdgs.dimap.AGEOMETRICINFOTILE.TileGeocoding.class
})
public class ATILEDESCRIPTION {
    ...
    protected List<ATILEDESCRIPTION.Size> size;
    @XmlElement(name = "Geoposition", required = true)
    protected List<ATILEDESCRIPTION.Geoposition> geoposition;
     ...
     * {@link ATILEDESCRIPTION.Size }
     * 
     * 
     */
    public List<ATILEDESCRIPTION.Size> getSize() {
        if (size == null) {
            size = new ArrayList<ATILEDESCRIPTION.Size>();
        }
        return this.size;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ATILEDESCRIPTION.Geoposition }
     * 
     * 
     */
    public List<ATILEDESCRIPTION.Geoposition> getGeoposition() {
        if (geoposition == null) {
            geoposition = new ArrayList<ATILEDESCRIPTION.Geoposition>();
        }
