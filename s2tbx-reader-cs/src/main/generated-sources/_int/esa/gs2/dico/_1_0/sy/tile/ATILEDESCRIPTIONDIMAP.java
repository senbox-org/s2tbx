 ...
 * 
 * <p>Classe Java pour A_TILE_DESCRIPTION_DIMAP complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="A_TILE_DESCRIPTION_DIMAP">
 *   &lt;complexContent>
...
@XmlType(name = "A_TILE_DESCRIPTION_DIMAP", propOrder = {
    "horizontalcsname",
    "horizontalcscode",
    "size",
    "geoposition"
})
public class ATILEDESCRIPTIONDIMAP {
    ...
    protected List<ATILEDESCRIPTIONDIMAP.Size> size;
    @XmlElement(name = "Geoposition", required = true)
    protected List<ATILEDESCRIPTIONDIMAP.Geoposition> geoposition;
     ...
     * {@link ATILEDESCRIPTIONDIMAP.Size }
     * 
     * 
     */
    public List<ATILEDESCRIPTIONDIMAP.Size> getSize() {
        if (size == null) {
            size = new ArrayList<ATILEDESCRIPTIONDIMAP.Size>();
        }
        return this.size;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ATILEDESCRIPTIONDIMAP.Geoposition }
     * 
     * 
     */
    public List<ATILEDESCRIPTIONDIMAP.Geoposition> getGeoposition() {
        if (geoposition == null) {
            geoposition = new ArrayList<ATILEDESCRIPTIONDIMAP.Geoposition>();
        }
