...
/**
 * List of 3D vertices counter-clockwise oriented (for WFS compatibility). The polygon must be closed (the first and last vertices are the same).
 * 
 * <p>Classe Java pour A_GML_POLYGON_3D complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="A_GML_POLYGON_3D">
 *   &lt;complexContent>
...
@XmlType(name = "A_GML_POLYGON_3D", propOrder = {
    "extposlist",
    "intposlist"
})
public class AGMLPOLYGON3D {
