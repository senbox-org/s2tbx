 ...
 */
package org.esa.s2tbx.mosaic.io;
...
public class S2tbxFileArrayEditor {
     ...
     */
    public S2tbxFileArrayEditor(final EditorParent parent, String label) {
    ...
    public JButton createMoveUpFileButton() {
        final JButton moveUpButton = (JButton) ToolButtonFactory.createButton(UIUtils.loadImageIcon("icons/MoveUp24.gif"), false);
        setName(moveUpButton, "moveUpProductButton");
        moveUpButton.addActionListener(e -> onMoveUpButton());
        return moveUpButton;
    }
    public JButton createMoveDownFileButton() {
        final JButton moveDownButton = (JButton) ToolButtonFactory.createButton(UIUtils.loadImageIcon("icons/MoveDown24.gif"), false);
        setName(moveDownButton, "moveDownProductButton");
        moveDownButton.addActionListener(e -> onMoveDownButton());
        return moveDownButton;
    }
    public JButton createRemoveFileButton() {
        final JButton removeButton = (JButton) ToolButtonFactory.createButton(UIUtils.loadImageIcon("icons/Minus24.gif"), false);
    ...
    public JButton createAddFileButton() {
        final JButton addButton = (JButton) ToolButtonFactory.createButton(UIUtils.loadImageIcon("icons/Plus24.gif"), false);
    ...
    /*
     * Callback invoked by the move up button
     */
    ...
    /*
     * Callback invoked by the move down button
     */
