...
class InstrumentConsts {
    ...
    public static final String VALID_RETRIEVAL_EXPRESSION =
            IDEPIX_FLAG_BAND_NAME + ".IDEPIX_LAND "
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_INVALID "
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_SNOW_ICE "
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CLOUD_SURE "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CLOUD_SHADOW "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CLOUD_AMBIGUOUS "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CLOUD_BUFFER "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CIRRUS_SURE "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_CIRRUS_AMBIGUOUS "   // ???
                    + " && !" + IDEPIX_FLAG_BAND_NAME + ".IDEPIX_BRIGHTWHITE "   // ???
