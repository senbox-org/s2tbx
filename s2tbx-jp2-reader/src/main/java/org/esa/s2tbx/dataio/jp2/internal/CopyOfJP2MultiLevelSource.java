 ...
 * @author Cosmin Cara
 */
public class CopyOfJP2MultiLevelSource extends AbstractMosaicSubsetMultiLevelSource implements DecompressedTileOpImageCallback<Void> {
    ...
    public CopyOfJP2MultiLevelSource(JP2ImageFile jp2ImageFile, Path localCacheFolder, Dimension defaultImageSize, Rectangle imageReadBounds, int bandCount,
    ...
    public SourcelessOpImage buildTileOpImage(Dimension decompresedTileSize, Dimension tileSize, Point tileOffsetFromDecompressedImage,
        ...
        return new CopyOfJP2TileOpImage(this.jp2ImageFile, this.localCacheFolder, getModel(), decompresedTileSize, this.bandCount, this.bandIndex,
