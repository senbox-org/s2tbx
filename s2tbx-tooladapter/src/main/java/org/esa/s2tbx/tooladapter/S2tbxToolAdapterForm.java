 ...
 * Date: 13.07.11
 */
public class S2tbxToolAdapterForm extends JTabbedPane {
    ...
    public S2tbxToolAdapterForm(AppContext appContext, OperatorSpi operatorSpi, PropertySet propertySet,
        ...
        targetProductSelectorModel.setProductDir(this.propertySet.getProperty("toolWorkingDirectory").getValue());
