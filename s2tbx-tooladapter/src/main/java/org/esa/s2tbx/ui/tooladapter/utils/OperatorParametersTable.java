...
import org.esa.s2tbx.ui.tooladapter.TemplateParameterEditorDialog;
import org.esa.s2tbx.ui.tooladapter.ToolParameterEditorDialog;
...
public class OperatorParametersTable extends JTable {
    ...
    class MultiRenderer extends AbstractCellEditor implements TableCellEditor, TableCellRenderer {
        ...
        private AbstractButton delButton = ToolButtonFactory.createButton(UIUtils.loadImageIcon("/org/esa/s2tbx/resources/images/icons/DeleteShapeTool16.gif"),
                false);
