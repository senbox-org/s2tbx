 ...
 */
public class Sentinel2Product10MReaderPlugIn implements ProductReaderPlugIn {
    ...
    public ProductReader createReaderInstance() {
        BeamLogManager.getSystemLogger().info("Building product reader 10M");

        return new Sentinel2ProductReader(this, false, 10);
    }

    @Override
    public String[] getFormatNames() {
        return new String[]{S2Config.FORMAT_NAME+"-10M"};
    }
