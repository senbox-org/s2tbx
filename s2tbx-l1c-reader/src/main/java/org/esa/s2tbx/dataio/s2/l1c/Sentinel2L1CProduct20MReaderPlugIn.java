...
public abstract class Sentinel2L1CProduct20MReaderPlugIn extends Sentinel2L1CProductReaderPlugIn {
    ...
    public ProductReader createReaderInstance() {
        ...
        return new Sentinel2L1CProductReader(this, S2SpatialResolution.R20M.resolution, false, getEPSG());
    }

    @Override
    public String[] getFormatNames() {
        return new String[]{String.format("%s-20M-%s", FORMAT_NAME, epsgToShortDisplayName(getEPSG()))};
    }
