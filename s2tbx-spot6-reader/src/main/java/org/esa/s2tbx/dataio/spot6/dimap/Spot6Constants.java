...
public class Spot6Constants {
    ...
    public static final String SPOT6_UTC_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";
    ...
    public static final String PATH_IMG_ADJUSTMENT_BIAS = "/dimap_document/radiometric_data/dynamic_adjustment/band_adjustment_list/band_adjustment/bias";
    public static final String PATH_IMG_ADJUSTMENT_SLOPE = "/dimap_document/radiometric_data/dynamic_adjustment/band_adjustment_list/band_adjustment/slope";
