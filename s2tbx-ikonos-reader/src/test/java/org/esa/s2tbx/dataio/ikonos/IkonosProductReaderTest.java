...
public class IkonosProductReaderTest {
    ...
    private String productFolder = "ikonos" + File.separator;
    ...
    public void testReadProductNodes() {
        ...
        File file = TestUtil.getTestFile(productFolder + "IK2_OPER_OSA_GEO_1P_20080820T092600_N38-054_E023-986_0001.SIP.ZIP/IK2_OPER_OSA_GEO_1P_20080820T092600_N38-054_E023-986_0001.MD.XML");
        ...
        try {
            ...
            assertEquals(3692, product.getSceneRasterWidth());
            assertEquals(3317, product.getSceneRasterHeight());
            assertEquals("2008-08-20T09:26:00Z", product.getStartTime().toString());
            assertEquals("2008-08-20T09:26:00Z", product.getEndTime().toString());
