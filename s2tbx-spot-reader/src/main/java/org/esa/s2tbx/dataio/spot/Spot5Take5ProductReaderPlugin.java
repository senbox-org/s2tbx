...
public class Spot5Take5ProductReaderPlugin extends BaseProductReaderPlugIn {
    ...
    public static class StartOp implements Runnable {
        ...
        @Override
        public void run() {
            copyColorPaletteFileFromResources(SpotTake5ProductReaderPlugin.class.getClassLoader(), "org/esa/s2tbx/dataio/spot/", SpotTake5ProductReaderPlugin.SPOT_TAKE5_COLOR_PALETTE_FILE_NAME);
        }
    }
}
