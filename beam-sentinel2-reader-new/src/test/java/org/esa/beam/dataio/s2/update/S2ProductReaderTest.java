...
public class S2ProductReaderTest {
    ...
    @Before
    public void setup() {
        final S2PlugIn s2PPlugIn = new S2PlugIn();
    ...
    @Test
    @Ignore
    public void testReadingL1CTileFromDirectory() throws Exception {
        final File file = new File(testDataDir + "Level-1C_User_Product\\GRANULE\\S2A_HOWL_MSI_L1C_TL_CGS3_20131012T012355_049_15SWD");
