...
public class WorldViewESAarchiveProductReaderTest {
    private WorldViewESAarchiveProductReader reader;
    ...
    public void setup() {
        ...
        WorldViewESAarchiveProductReaderPlugin plugin = new WorldViewESAarchiveProductReaderPlugin();
        reader = new WorldViewESAarchiveProductReader(plugin);
    }
    ...
    public void testGetReaderPlugin() {
        assertEquals(WorldViewESAarchiveProductReaderPlugin.class, reader.getReaderPlugIn().getClass());
    }
    ...
    public void testReadProductNodes() {
        ...
        try {
            ...
            assertEquals(WorldViewESAarchiveConstants.PRODUCT_TYPE, finalProduct.getProductType());
