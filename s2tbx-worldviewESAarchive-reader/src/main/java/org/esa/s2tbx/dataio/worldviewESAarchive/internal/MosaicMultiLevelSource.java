...
package org.esa.s2tbx.dataio.worldviewESAarchive.internal;
...
public class MosaicMultiLevelSource extends AbstractMultiLevelSource {
    ...
    public MosaicMultiLevelSource(Band[][] sourceBands, int imageWidth, int imageHeight,
                                  int tileWidth, int tileHeight, int upperLeftColumnOffset, int upperLeftRowOffset, int numTilesX, int numTilesY, int levels, int dataType,
                ...
                try {
                    ...
                    if (opImage != null) {
                        opImage = TranslateDescriptor.create(opImage,
                                (float) (x * upperLeftColumnOffset * factorX),
                                (float) (y * upperLeftRowOffset * factorY),
