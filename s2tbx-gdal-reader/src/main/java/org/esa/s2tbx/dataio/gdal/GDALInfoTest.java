...
public class GDALInfoTest {
    ...
    public static void main(String[] args) {
        {
            args = new String[] {"--help-general", "--optfile D:/U_1001A.NTF"};
            Dataset hDataset;
            Band hBand;
            int i, iBand;
...
//            pszFilename = "D:/U_1001A.NTF";
//            pszFilename = "D:/3_8bit_components_srgb.jp2";
//            pszFilename = "D:/2009-05-06T194022_RE3_1B-NAC_3436549_84301_band3.ntf";
//            pszFilename = "D:/1_12bit_component_srgb.jp2";
            pszFilename = "D:/S2A_OPER_MSI_L1C_TL_SGS__20160125T132659_A003093_T34TGQ_B01.jp2";
            ...
            if (hDataset.GetProjectionRef() != null) {
                ...
                if (hSRS != null && pszProjection.length() != 0) {
                    ...
                    System.out.println("Coordinate System is '" + hDataset.GetProjectionRef() + "'");
                }
                hSRS.delete();
            }
            ...
            for (iBand = 0; iBand < hDataset.getRasterCount(); iBand++) {
                ...
                System.out.println("  OverviewCount=" + hBand.GetOverviewCount());
                if (hBand.GetOverviewCount() > 0) {
                    ...
                    for (iOverview = 0; iOverview < hBand.GetOverviewCount(); iOverview++) {
                        ...
                        Band  hOverview = hBand.GetOverview(iOverview);
