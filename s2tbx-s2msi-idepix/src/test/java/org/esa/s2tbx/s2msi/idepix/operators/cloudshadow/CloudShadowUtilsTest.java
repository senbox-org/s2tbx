...
public class CloudShadowUtilsTest {
    ...
    public void testGetRelativePath_45() throws Exception {
        ...
        final Point2D[] expectedPath = list.toArray(new Point[list.size()]);

        /*for(int i=0; i< expectedPath.length; i++) {
            System.out.println(expectedPath[i].getX() + " " + expectedPath[i].getY());
        }*/
    ...
    private void testRelativePath(float saa, Point2D[] expectedPath) throws IOException {
