...
public class RecommendedCloudShadowFlagger {
    ...
    void RecommendedCloudShadowFlagger(int bestOffset, int[] flagArray, Rectangle sourceRectangle){
        this.flagArray = flagArray;
        this.sourceWidth = sourceRectangle.width;
        this.sourceHeight = sourceRectangle.height;
        this.bestOffset = bestOffset;

        setRecommendedCloudShadowFlag();
    }

    private void setRecommendedCloudShadowFlag(){
        if(bestOffset > 0){
