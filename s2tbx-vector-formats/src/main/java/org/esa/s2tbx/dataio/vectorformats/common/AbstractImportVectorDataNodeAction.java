package org.esa.s2tbx.dataio.vectorformats.common;
...
public abstract class AbstractImportVectorDataNodeAction extends AbstractSnapAction {
    ...
    protected AbstractImportVectorDataNodeAction() {
        crsProvider = new AbstractImportVectorDataNodeAction.MyFeatureCrsProvider();
        placemarkDescriptorProvider = new AbstractImportVectorDataNodeAction.MyPlacemarkDescriptorProvider();
    }
