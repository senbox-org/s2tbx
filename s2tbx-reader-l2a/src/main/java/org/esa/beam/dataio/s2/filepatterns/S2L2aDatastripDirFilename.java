...
public class S2L2aDatastripDirFilename {
    ...
    private S2L2aDatastripDirFilename(String name, String missionID, String fileClass, String fileCategory, String fileSemantic, String siteCentre, String creationDate, String applicabilityStart, String processingBaseline) {
        this.name = name;
    ...
    public S2L2aDatastripFilename getDatastripFilename(String fileCategory)
    {
        ...
        return S2L2aDatastripFilename.create(tmp);
    }
