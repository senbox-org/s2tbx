...
public class S2L2aProductFilename {
    ...
    private S2L2aProductFilename(String name, String missionID, String fileClass, String fileCategory, String fileSemantic, String siteCentre, String creationDate, String instanceID) {
        this.name = name;
    ...
    public static S2L2aProductFilename create(String fileName) {
        ...
        if (matcher.matches()) {
            return new S2L2aProductFilename(fileName,
                                            matcher.group(1),
                                            matcher.group(2),
                                            matcher.group(3),
                                            matcher.group(4),
