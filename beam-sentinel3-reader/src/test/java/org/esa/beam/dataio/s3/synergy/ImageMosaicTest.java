...
public class ImageMosaicTest {
    ...
    public void testCreateMosaicImage() throws Exception {
        ...
        final RenderedImage mosaicImage = ImageMosaic.create(image1, image2, image3, image4, image5);
    ...
    public void testCreateMosaicMultiLevelImage() throws Exception {
        ...
        final MultiLevelImage mosaicImage = ImageMosaic.create(image1, image2, image3, image4, image5);
