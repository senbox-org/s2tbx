 ...
 */
public abstract class S2GranuleDirFilename {
    ...
    protected S2GranuleDirFilename(String name, String missionID, String fileClass, String fileCategory, String fileSemantic, String siteCentre, String creationDate, String processingBaseline) {
        this.name = name;
    ...
    public abstract S2GranuleMetadataFilename getMetadataFilename();
