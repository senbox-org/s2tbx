...
public class S2GranuleMetadataFilename {
    ...
    protected S2GranuleMetadataFilename(String name, String missionID, String fileClass, String fileCategory, String fileSemantic, String siteCentre, String creationDate) {
        this.name = name;
