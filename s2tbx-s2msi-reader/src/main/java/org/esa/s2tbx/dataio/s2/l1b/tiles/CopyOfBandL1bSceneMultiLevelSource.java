 ...
 */
public class CopyOfBandL1bSceneMultiLevelSource extends AbstractMatrixMosaicSubsetMultiLevelSource implements DecompressedTileOpImageCallback<S2MosaicBandMatrixCell> {
    ...
    protected List<RenderedImage> buildMatrixCellTileImages(int level, Rectangle imageCellReadBounds, float translateLevelOffsetX, float translateLevelOffsetY, MosaicMatrix.MatrixCell matrixCell) {
        S2MosaicBandMatrixCell l1bMosaicMatrixCell = (S2MosaicBandMatrixCell)matrixCell;
