...
public class S2OrthoGranuleDirFilename extends S2GranuleDirFilename {
    ...
    final static String REGEX = "(S2A|S2B|S2C|S2_|LS8|LS9)_([A-Z|0-9]{4})_([A-Z|0-9|_]{4})([A-Z|0-9|_]{3,6})_([A-Z|0-9|_]{3,4})_([0-9]{8}T[0-9]{6})_(A[0-9]{6})_(T[A-Z|0-9]{5})(_N[0-9]{2}\\.[0-9]{2})(\\.[A-Z|a-z|0-9]{3,4})?";
