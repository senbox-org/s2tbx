 ...
 */
public class L1cPSD148Constants {

    private final static String PRODUCT_SCHEMA_FILE_PATH = "schemas/PSD148/S2_User_Product_Level-1C_Metadata.xsd";
    private final static String GRANULE_SCHEMA_FILE_PATH = "schemas/PSD148/S2_PDI_Level-1C_Tile_Metadata.xsd";
    private final static String DATASTRIP_SCHEMA_FILE_PATH = "schemas/PSD148/S2_PDI_Level-1C_Datastrip_Metadata.xsd";
