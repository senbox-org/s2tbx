...
public class SAFECOMPACTNamingConvention implements INamingConvention {
    //REGEXs and getters
    public static String PRODUCT_REGEX = "(S2A|S2B|S2C|S2D|S2_|LS8|LS9)_([A-Z|0-9|_]{6})_([0-9]{8}T[0-9]{6})_N([0-9]{4})_R([0-9]{3})_.*";
    // MTD_OLIL2F
    public static String PRODUCT_XML_REGEX = "MTD_(MSIL(1C|2A|2H|2F|03)|OLIL2(H|F))\\.xml";
    public static String GRANULE_REGEX = "(L1C|L2A|L2H|L2F|L03)_T([A-Z|0-9|_]{5})_A([0-9]{6})_([0-9]{8}T[0-9]{6})(|_(S2A|S2B|S2C|S2D|S2_|LS8|LS9)_R([0-9]{3}))";
