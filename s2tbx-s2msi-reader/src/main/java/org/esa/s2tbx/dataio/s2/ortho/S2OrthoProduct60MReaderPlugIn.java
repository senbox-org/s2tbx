...
public abstract class S2OrthoProduct60MReaderPlugIn extends S2OrthoProductReaderPlugIn {
    ...
    public ProductReader createReaderInstance() {
        SystemUtils.LOG.info(String.format("Building product reader 60M - %s", getEPSG()));
        return new Sentinel2OrthoProductReaderProxy(this, Sentinel2ProductReader.ProductInterpretation.RESOLUTION_60M, getEPSG());
    }
