...
public class SpatioTempTargetProductSelectorModel {
    ...
    public SpatioTempTargetProductSelectorModel() {
        this(ProductIOPlugInManager.getInstance().getAllProductWriterFormatStrings());
    }

    public SpatioTempTargetProductSelectorModel(String[] formatNames) {
