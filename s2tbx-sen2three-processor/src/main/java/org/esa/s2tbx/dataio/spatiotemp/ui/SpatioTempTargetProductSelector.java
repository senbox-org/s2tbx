 ...
 */
public class SpatioTempTargetProductSelector {
    ...
    private SpatioTempTargetProductSelectorModel model;

    public SpatioTempTargetProductSelector(SpatioTempTargetProductSelectorModel model) {
        this.model = model;
    ...
    public SpatioTempTargetProductSelectorModel getModel() {
        return model;
    }
