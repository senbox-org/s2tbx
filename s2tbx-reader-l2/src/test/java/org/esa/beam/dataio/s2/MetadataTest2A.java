...
import _int.esa.gs2.dico._1_0.pdgs.dimap.A_L2A_Product_Info;
import _int.esa.gs2.dico._1_0.pdgs.dimap.A_PRODUCT_ORGANIZATION_2A;
...
public class MetadataTest2A {
    ...
    public void test2() throws Exception
    {
        ...
        A_PRODUCT_ORGANIZATION_2A.Granules granulesList = info.getGranule_List().get(0).getGranules();
